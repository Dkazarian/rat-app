...
For this intermediate phase and subsequent client integration, the following contracts replace the corresponding Phase 3/4 assumptions and earlier client-architecture guidance in `specs/techstack.md`. Other product requirements continue to apply.
